...
contract PollCommitRevealTest is Test {
    ...
    function _openPoll() internal returns (Poll created) {
        created = new Poll();
        created.initialize(creator, "Private?", _cids(3), FAR_FUTURE, _config());
    ...
    function test_Commitment_IsBoundToThePollAddress() public {
        ...
        Poll other = new Poll();
        other.initialize(creator, "Other?", _cids(3), FAR_FUTURE, _config());
    ...
    function test_Phase_PlainPollStillEndsDirectly() public {
        Poll plain = new Poll();
        plain.initialize(creator, "Plain?", _cids(3), FAR_FUTURE, PollMechanisms.defaultConfig(0));
    ...
    function test_MultiSelectCommit_IsBoundToTheWholeSet() public {
        ...
        Poll multi = new Poll();
        multi.initialize(creator, "Multi private?", _cids(3), FAR_FUTURE, config);
